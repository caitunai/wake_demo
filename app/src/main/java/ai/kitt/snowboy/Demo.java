...
public class Demo extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        activeTimes = 0;
        String audioPath = this.getFilesDir().getAbsolutePath() + "/snowboy-recording.pcm";
        recordingThread = new RecordingThread(this, Constants.ACTIVE_RES, Constants.ACTIVE_UMDL, handle, new AudioDataSaver(audioPath));
        playbackThread = new PlaybackThread(audioPath);
    }
    ...
    private void setUI() {
        ...
        swap_button = findViewById(R.id.btn_swap);
        swap_button.setOnClickListener(v -> {
            recordingThread.updateModel(Constants.ACTIVE_RES, Constants.ALEXA_UMDL, "0.6", 1, true);
        });
